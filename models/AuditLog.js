...
const AuditLogSchema = new mongoose.Schema({
  action: {
    ...
    enum: [
      ...
      'USER_REGISTRATION', 'EMAIL_VERIFY', 'PHONE_VERIFY', 'PROFILE_UPDATE',
      'WISHLIST_ADD', 'WISHLIST_REMOVE', 'LOGS_CLEARED', 'USER_UNLOCKED',
      'LOYALTY_ADJUSTMENT', 'LOYALTY_REDEMPTION', 'INVOICE_GENERATION', 'LEAD_DELETE', 'LEAD_UPDATE'
    ],
  },
  user: {
